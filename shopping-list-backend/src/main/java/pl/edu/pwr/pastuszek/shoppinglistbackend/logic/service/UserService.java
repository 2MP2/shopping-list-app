...
public class UserService extends MappedCrudService<User, UserRequestDTO, UserResponseDTO> {
    public UserService(UserRepository repository, UserDTOMapper mapper, UserSpecifications userSpecifications) {
        super(repository, LoggerFactory.getLogger(UserService.class), mapper, userSpecifications);
    }
