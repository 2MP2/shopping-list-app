...
public class UserOrganizationService extends MappedCrudService<UserOrganization, UserOrganizationRequestDTO, UserOrganizationResponseDTO> {
    public UserOrganizationService(BaseRepository<UserOrganization> repository, UserOrganizationDTOMapper mapper) {
        super(repository, LoggerFactory.getLogger(UserOrganizationService.class), mapper);
    }
}
