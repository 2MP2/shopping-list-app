...
public class ShoppingListService extends MappedCrudService<ShoppingList, ShoppingListRequestDTO, ShoppingListResponseDTO> {
    public ShoppingListService(BaseRepository<ShoppingList> repository, ShoppingListDTOMapper mapper) {
        super(repository, LoggerFactory.getLogger(ShoppingListService.class), mapper);
    }
}
