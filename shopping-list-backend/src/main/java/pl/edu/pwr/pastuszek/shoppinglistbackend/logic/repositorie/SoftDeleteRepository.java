...
import pl.edu.pwr.pastuszek.shoppinglistbackend.model.entity.SoftEntity;
...
@NoRepositoryBean
public interface SoftDeleteRepository<T extends SoftEntity> extends BaseRepository<T>{
